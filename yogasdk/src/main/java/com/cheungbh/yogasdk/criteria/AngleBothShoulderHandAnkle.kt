...
class AngleBothShoulderHandAnkle : CriteriaBase() {
    ...
    private fun updateScore(){
        this.leftScore = FeedbackUtilities.left_shoulder_hand_ankle(this.keypoint!!, this.max_angle, this.step, false)
        this.rightScore = FeedbackUtilities.right_shoulder_hand_ankle(this.keypoint!!, this.max_angle, this.step, false)
        this.score = 0.5*this.rightScore + 0.5* this.leftScore
    }

    private fun updateColorBit(){
//        this.leftColorBit = ColorUtilities.left_shoulder_hand_ankle(this.leftScore)
//        this.rightColorBit = ColorUtilities.right_shoulder_hand_ankle(this.rightScore)
