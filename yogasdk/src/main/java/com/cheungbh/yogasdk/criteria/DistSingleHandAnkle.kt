...
//class DistSingleHandAnkle: CriteriaBase() {
//
//    private var max_dist_ratio: Double = 0.0
...
//        this.max_dist_ratio = maxAngle
//        this.step = step
//        this.direction = direction
//
//        if (this.max_dist_ratio > 160){
...
//        }else if (this.max_dist_ratio < 60){
//            this.good_performance = this.direction + " arm is curve enough"
//            this.bad_performance = this.direction + " arm is not curve enough"
//        }else{
//            this.good_performance = this.direction + " arm is close to " + this.max_dist_ratio.toString() + " degree"
//            this.bad_performance = this.direction + " arm is not close to " + this.max_dist_ratio.toString() + " degree"
//        }
//    }
//
//    private fun updateScore(){
//        if (this.direction == LEFT){
//            this.score = FeedbackUtilities.left_arm(this.keypoint!!, this.max_angle, this.step, false)
//        }else if (this.direction == RIGHT){
//            this.score = FeedbackUtilities.right_arm(this.keypoint!!, this.max_angle, this.step, false)
//        }
//    }
//
//    private fun updateColorBit(){
//        if (this.direction == LEFT){
//            this.colorbit = ColorUtilities.left_arm(this.score)
//        }else if (this.direction == RIGHT){
//            this.colorbit = ColorUtilities.right_arm(this.score)
//        }
//    }
//
