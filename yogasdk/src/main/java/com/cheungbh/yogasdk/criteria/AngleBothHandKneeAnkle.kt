...
class AngleBothHandKneeAnkle : CriteriaBase() {
    ...
    private fun updateScore(){
        this.leftScore = FeedbackUtilities.left_hand_knee_ankle(this.keypoint!!, this.max_angle, this.step, false)
        this.rightScore = FeedbackUtilities.right_hand_knee_ankle(this.keypoint!!, this.max_angle, this.step, false)
        this.score = 0.5*this.rightScore + 0.5* this.leftScore
    }

    private fun updateColorBit(){
//        this.leftColorBit = ColorUtilities.left_hand_knee_ankle(this.leftScore)
//        this.rightColorBit = ColorUtilities.right_hand_knee_ankle(this.rightScore)
