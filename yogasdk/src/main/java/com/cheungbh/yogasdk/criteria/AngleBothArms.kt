...
class AngleBothArms : CriteriaBase() {
    ...
    private fun updateScore(){
        this.leftScore = FeedbackUtilities.left_arm(this.keypoint!!, this.max_angle, this.step, false)
        this.rightScore = FeedbackUtilities.right_arm(this.keypoint!!, this.max_angle, this.step, false)
