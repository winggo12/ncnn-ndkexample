...
class Halasana: YogaBase() {

    override val poseName: String = Pose.Halasana
    ...
    private fun calculateScore(): Double{
        ...
        val right_leg_score = FeedbackUtilities.right_waist(resultArray!!, 180.0, 20.0, true)
        ...
        waist_score = FeedbackUtilities.right_waist(resultArray!!, 45.0, 20.0, true)
