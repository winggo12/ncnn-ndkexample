...
//  val filename: String = "posenet_model.tflite",
  val filename: String = "mobilnetv2False2020-05-11-12-17-45.tflite",
...
//            yOffset = 0
    ...
    keypointPositions.forEachIndexed { idx, position ->
      ...
      Log.i(
        "posenet",
        "positionX : " + positionX + " positionY : " + positionY +"offsetX : " + offsetX + " offsetY : " + offsetY
      )
//      yCoords[idx] = (
